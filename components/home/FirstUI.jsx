  ...
  return (
    <div className='relative flex flex-col justify-center items-center overflow-hidden pb-[550px]'>
      ...
      <div className='flex flex-row gap-5 mt-20 w-[990px] h-[490px]'>
         <div className='flex justify-center items-center bg-white p-[30px] rounded-[20px] w-[970px] h-[470px] z-[300] mt-[30px] animate-slideUp'>
            <MoviePoster />
         </div>
         <div className='flex justify-center items-center bg-white p-[30px] rounded-[20px] w-[970px] h-[470px] z-[300] animate-slideUp'>
            <MoviePoster />
         </div>
         <div className='flex justify-center items-center bg-white p-[30px] rounded-[20px] w-[970px] h-[470px] mt-[30px] z-[300] animate-slideUp'>
            <MoviePoster />
         </div>
      </div>
